...
<html>
    ...
    <body>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Editar Prazo</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="updatePrazo()">Salvar</button>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Criar Novo Prazo</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="createPrazo()">Salvar</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
            </div>
          </div>
        </div>
    ...
    <script>
        ...
        function deletePrazo(id, nome){
            if(confirm('Tem certeza que deseja remover a categoria: '+nome+'?')){
                window.location.href = '/AgendaUm/prazo.do?act=delete&id='+id;
            }
        }
        
        function editarPrazo(id, nome){
            $('#nome_input').val(nome);
            $('#id_input').val(id);
        ...
        function updatePrazo(){
            ...
            window.location.href = '/AgendaUm/prazo.do?act=edit&id='+id+'&nome='+nome;
        }
        ...
        function createPrazo(){
            ...
            window.location.href = '/AgendaUm/prazo.do?act=create&nome='+nome;
        }
    </script>
</html>
